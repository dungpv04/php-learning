...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $dbConn = new mysqli("localhost", "root", "", "QUESTIONS");
    if ($dbConn->connect_error) {
        fclose($fileHandle);
        die("Connection error: " . $dbConn->connect_error);
    }

    $dbConn->query("TRUNCATE TABLE QuestionList");
    ...
    foreach ($questionList as $question) {
        ...
        $stmt = $dbConn->prepare("INSERT INTO QuestionList (QuestionTitle, OptionA, OptionB, OptionC, OptionD, CorrectAnswers) VALUES (?, ?, ?, ?, ?, ?)");
